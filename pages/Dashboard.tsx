    ...
    <>
        <div className="dashboard text-center">
            <div className="flex items-start">
                <h1 className="pl-6 font-semibold mt-8 text-8xl text-left">blancP .-   -...   ---</h1>
        ...
        <div className="mt-5">
            <div className="flex flex-row p-2 gap-2">
                <div className="flex-row w-1/4 h-55 p-4 rounded-xl bg-zinc-900 shadow-md hover:shadow-lg transition-shadow">
                    <div className="flex">
                        <div className="flex flex-col gap-0">
                            <h2 className="font-bold text-gray-300 text-lg tracking-wide">
                            Streak Tracker
                            </h2>
                ...
                <div className="flex flex-col w-1/4 h-55 p-4 rounded-xl bg-zinc-900 shadow-md hover:shadow-lg transition-shadow">
                    <div className="flex">
                        <div>
                            <h2 className="font-bold text-gray-300 text-lg tracking-wide border-zinc-700">
                            Trajectory
                            </h2>
